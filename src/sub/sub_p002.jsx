...
const tableData = {
    ...
    기본구성_모바일: [
        '· PC + 모바일 반응형 <br/>· 템플릿 선택<br/>(텍스트, 이미지 등 내용 변경) <br/>· 메인 + 서브 5페이지',
        '· PC + 모바일 반응형 <br/>· 템플릿 선택<br/>(텍스트, 이미지 등 내용 변경) <br/>· 메인 + 서브 10페이지',
        '· PC + 모바일 반응형 <br/>· 템플릿 선택<br/>(텍스트, 이미지 등 내용 변경) <br/>· 메인 + 서브 15페이지',
    ],
        ...
        <section className='sub_p002'>
            <article>
                ...
                <div className="table_Cont">
                    ...
                    {isMo && (
                        <div className='ta_mo'>
                            <table className="ta_price" data-aos="fade-down">
                                <colgroup>
                                ...
                                <thead>
                                    <tr>
                                        <th colSpan={2}><p>비용</p></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td><p>{tableData.구분[0]}</p></td>
                                        <td><p>{tableData.비용[0]}</p></td>
                                    </tr>
                                    <tr>
                                        <td><p>{tableData.구분[1]}</p></td>
                                        <td><p>{tableData.비용[1]}</p></td>
                                    </tr>
                                    <tr>
                                        <td><p>{tableData.구분[2]}</p></td>
                                        <td><p>{tableData.비용[2]}</p></td>
                                    </tr>
                                </tbody>
                            </table>
                            <table className="ta_composition" data-aos="fade-down">
                                <colgroup>
                                    <col style={{ width: "80px" }} />
                                    <col style={{ width: "auto" }} />
                                </colgroup>
                                <thead>
                                    <tr>
                                        <th colSpan={2}><p>기본 구성</p></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td>{tableData.구분[0]}</td>
                                        <td className='compo'><p dangerouslySetInnerHTML={{ __html: tableData.기본구성_모바일[0] }} /></td>
                                    </tr>
                                    <tr>
                                        <td>{tableData.구분[1]}</td>
                                        <td className='compo'><p dangerouslySetInnerHTML={{ __html: tableData.기본구성_모바일[1] }} /></td>
                                    </tr>
                                    <tr>
                                        <td>{tableData.구분[2]}</td>
                                        <td className='compo'><p dangerouslySetInnerHTML={{ __html: tableData.기본구성_모바일[2] }} /></td>
                                    </tr>
                                </tbody>
                            </table>
                            <table className="ta_period" data-aos="fade-down">
                                <colgroup>
                                    <col style={{ width: "80px" }} />
                                    <col style={{ width: "auto" }} />
                                </colgroup>
                            ...
                            <table className="ta_freeOption" data-aos="fade-down">
                                <colgroup>
                                    <col style={{ width: "80px" }} />
                                    <col style={{ width: "auto" }} />
                                </colgroup>
                                ...
                                <tbody>
                                    <tr>
                                        <td className='bg_W'><p>{tableData.무상제공[0]}</p></td>
                                    </tr>
                                </tbody>
                            </table>
                            <table className="ta_basicOption" data-aos="fade-down">
                                <colgroup>
                                    <col style={{ width: "80px" }} />
                                    <col style={{ width: "auto" }} />
                                </colgroup>
                                ...
                                <tbody>
                                    <tr>
                                        <td className='bg_W'><p>{tableData.기본제공기능[0]}</p></td>
                                    </tr>
                                </tbody>
                            </table>
                            <table className="ta_etc" data-aos="fade-down">
                                <colgroup>
                                    <col style={{ width: "80px" }} />
                                    <col style={{ width: "auto" }} />
                                </colgroup>
                                ...
                                <tbody>
                                    <tr>
                                        <td className='bg_W'><p dangerouslySetInnerHTML={{ __html: tableData.기타[0] }} /></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
